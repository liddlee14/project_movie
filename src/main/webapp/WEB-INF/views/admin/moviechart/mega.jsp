<%@page import="com.koreait.movie.domain.MegaChart"%>
<%@page import="java.util.List"%>
<%@ page contentType="text/html;charset=UTF-8"%>
<%
List<MegaChart> megaList=(List)request.getAttribute("mchart");
%>
<!DOCTYPE html>
<html lang="en">
<head>
