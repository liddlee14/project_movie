              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr onClick="location.href='/admin/board/detail?board_id=<%=board.getBoard_id()%>';">
                    ...
                    <tr>
						...
						<a href="/admin/board/list.jsp?currentPage=<%=i%>" <%if(pagingManager.getCurrentPage()==i){%>class="pageNum"<%}%>><%=i%></a>
						<%}%>
	               		</td>	
               		</tr>
