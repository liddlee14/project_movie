...
<%
   Admin adminDetail=(Admin)request.getAttribute("admin");
%>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
   <div>
              <div class="card-header">
                <h3 class="card-title">관리자 상세정보</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal">
                <div class="card-body">            
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input  class="form-control" name="host_id" placeholder="아이디" value="<%=adminDetail.getHost_id() %>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" name="name" value="<%=adminDetail.getName() %>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input  class="form-control" name="password" placeholder="비밀번호" value="<%=adminDetail.getPassword() %>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input  class="form-control" name="birth" placeholder="ex)940916" value="<%=adminDetail.getBirth() %>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" name="email" placeholder="Email" value="<%=adminDetail.getEmail() %>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input  class="form-control" name="phone" placeholder="- 없이 적어주세요" value="<%=adminDetail.getPhone() %>">
                    </div>
                  </div>
