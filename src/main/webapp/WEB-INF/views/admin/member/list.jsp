              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap" >
                  ...
                  <tbody>
                    ...
                    <%
                    	Admin ad=adminList.get(curPos++);
                    %>
                       <tr onclick="location.href='/admin/member/detail?admin_id=<%=ad.getAdmin_id()%>';">                                 
                         <td><%=ad.getHost_id() %></td>
                         <td><%=ad.getName() %></td>
                         <td><%=ad.getBirth() %></td>
                         <td><%=ad.getEmail() %></td>
                     ...
                     <tr>
						...
						<a href="/admin/member/list.jsp?currentPage=<%=i%>" <%if(pagingManager.getCurrentPage()==i){%>class="pageNum"<%}%>><%=i%></a>
						<%}%>
	               		</td>	
               		</tr>
