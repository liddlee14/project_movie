...
<%
	List<Client> clientList=(List)request.getAttribute("clientList");
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
					...
					<%if(num<1)break; %> 					
                 	<%
                 		Client client=clientList.get(curPos++);
                 	%>
	                    <tr onclick="location.href='/admin/clientmember/detail?client_id=<%=client.getClient_id()%>';">            	                  
               		...
               		<tr>
						...
						<a href="/admin/clientmember/list.jsp?currentPage=<%=i%>" <%if(pagingManager.getCurrentPage()==i){%>class="pageNum"<%}%>><%=i%></a>
						<%}%>
	               		</td>	
               		</tr>
                  </tbody>
