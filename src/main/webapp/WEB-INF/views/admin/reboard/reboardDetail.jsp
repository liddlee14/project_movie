              ...
              <form class="form-horizontal">
                <div class="card-body">            
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input  class="form-control" name="writer"  value="<%=reboard.getWriter()%>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" name="title" value="<%=reboard.getTitle()%>">
                    </div>
                  </div>
                ...
                <div style="float: right;">				          
                  <button type="button" class="btn btn-info" id="bt_reply">답변</button>
...
function reply(){
	   $("form").attr({
	      action:"/admin/reboard/replyform",
	      method:"post"
	   });   
	   $("form").submit();
	}
