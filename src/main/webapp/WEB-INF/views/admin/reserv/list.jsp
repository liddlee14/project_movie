...
<%
	List<Reserv> reservList=(List)request.getAttribute("reservList");
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap" >
                  ...
                  <tbody>
                    ...
                    <%
                    	Reserv rs=reservList.get(curPos++);
                    %>
                       <tr>                                 
                         <td><%=rs.getClient_id() %></td>
                         <td><%=rs.getMovie() %></td>
                         <td><%=rs.getTheater() %></td>
                         <td><%=rs.getArea() %></td>
                         <td><%=rs.getDate() %></td>
                     ...
                     <tr>
						...
						<a href="/admin/reserv/list.jsp?currentPage=<%=i%>" <%if(pagingManager.getCurrentPage()==i){%>class="pageNum"<%}%>><%=i%></a>
						<%}%>
	               		</td>	
               		</tr>
