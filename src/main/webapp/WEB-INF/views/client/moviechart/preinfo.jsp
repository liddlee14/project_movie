<%@page import="com.koreait.movie.domain.PreInfo"%>
<%@page import="java.util.List"%>
<%@ page contentType="text/html;charset=UTF-8"%>
<%
PreInfo mi=(PreInfo)request.getAttribute("info");
...
<input type="hidden" name="p_title" value="<%=mi.getP_title() %>"></input>
	<div class="container">
		<div class="row ipad-width2">
			...
			<div class="col-md-8 col-sm-12 col-xs-12">
				<div class="movie-single-ct main-content">
					<h1 class="bd-hd"><%=mi.getI_title() %> <span></span></h1>
