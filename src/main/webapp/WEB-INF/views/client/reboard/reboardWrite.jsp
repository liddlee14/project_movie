					...
					<form  class="user" id="formU">
						...
						<div class="row">
							...
							<div class="col-md-6 form-it">
								...
								<input type="text" readonly="readonly" name="writer" value="<%=client.getUser_id()%>">
							</div>
						</div>
							<label>내용</label>
						...
						<div class="row">
							<div class="col-md-2">
								<button id="bt_regist" type="button" onClick="regist()">등록</button>
							</div>
						</div>	
					</form>
