...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ko" lang="ko"><head>
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=kOrrMtxLuWGiRjYB0IIDA7EUhoynjc%2bbKguJOggJEgktCxWG0aCQPQBlUer7dLqIJSLz9bp5NwSvr2X0RKIm5UFzU2RNdEV1b0pzalcrdlp6K2toUXhFbDFHYnNHazdnaFk5cWQwdzZqV2cweHQ0MllvNDNVSlErbGJkemdiem8%3d"></script>
...
<script type="text/javascript">
        ...
        $(function () {
            ...
            function goSearch($objKeyword) {
				...
				<div class="sect-srh">
					...
					<fieldset>
						<legend>통합검색</legend>
						<input type="text" title="통합검색" id="header_keyword" name="header_keyword" minlength="2" maxlength="20" placeholder="레미니센스">
                        <input type="hidden" id="header_ad_keyword" name="header_ad_keyword" value="레미니센스">
	...
	<div id="contaniner">
        ...
        <iframe title="CGV 빠른예매" id="ticket_iframe" src="http://ticket.cgv.co.kr/Reservation/Reservation.aspx?MOVIE_CD=&amp;MOVIE_CD_GROUP=&amp;PLAY_YMD=&amp;THEATER_CD=&amp;PLAY_NUM=&amp;PLAY_START_TM=&amp;AREA_CD=&amp;SCREEN_CD=&amp;THIRD_ITEM=" scrolling="no" frameborder="0" width="100%" height="997" style="width:100%; border:0 none;"></iframe>
		<!-- /Contents Area -->
	</div>
	<!-- /Contaniner -->
